...
class Goods(models.Model):
    ...
    fromtime = models.DateTimeField(verbose_name=u"开始时间",null=True)
    totime = models.DateTimeField(verbose_name=u"结束时间",null=True)
    ...
    location = models.CharField(max_length=100,verbose_name=u"地点",null=True)
